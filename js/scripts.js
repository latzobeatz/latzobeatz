...
const getSongs= () =>{
  $.ajax({
    ...
    $row.addClass('track');
      ...
      let $license =$('<td class="song_license"><select class="license-select" name="licenses"><option value="MP3">Basic Mp3</option><option value="WAV">Premium WAV</option><option value="Premium">WAV Multipistes</option><option value="Unlimited">Exclusive</option></select></td>');
      let $price = $('<td colspan="1" class="song_price"><span class="price">15000</span> FCFA <a data-id='+ song_id +' href="cart.php" class="add-btn"><span class="fa fa-shopping-cart"></span> ADD</a></td>');
