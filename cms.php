     ...
     <ul>
      <li>
        ...
        <ul id="beats" class="collapse">
            <li><a href="cms.php?source=beats" class="active">Tout</a></li>
            <li><a href="cms.php?source=add_beat" class="active">Ajouter</a></li>
        </ul>
      </li>
      <li>
        <a href="javascript:;" data-toggle="collapse" data-target="#posts">Music Posts <i class="fa fa-fw fa-caret-down"></i></a>
        <ul id="posts" class="collapse">
            <li><a href="cms.php?source=posts">Tout</a></li>
            <li><a href="cms.php?source=add_post">Ajouter</a></li>
        </ul>
       </li>
       
       <li><a href="cms.php?source=accounts">Comptes Utilisateur</a></li>
     </ul>
